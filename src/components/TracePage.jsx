                        ...
                        <form id="trace" method="POST" action="">
                            <div className="col-md-6">
                                <div className="form-group">
                                    <label className="control-label" for="keyValue">Lot Number</label>
                                    <input className="form-control" placeholder="Lot Number" value="" id="lotNumber"
                                        name="keyValue" type="text" />
                                </div>
                            </div>
                            <div className="col-md-6">
                                <div className="form-group">
                                    <label className="control-label" for="keyValue">Consignment Number</label>
                                    <input className="form-control" placeholder="Consignment Number" value=""
                    ...
                    <div className="panel-body">
                        <div className="rw-container">
                            <div className="stage-header">
                                <span class="stage-title">Fraccionado</span> - Nro de lote - Nro partida - fecha
                            </div>
                        ...
                        <div className="rw-container">
                            <div className="stage-header">
                                <span class="stage-title">Homogeneizado</span> - Nro de lote - Nro partida - fecha
                            </div>
                        ...
                        <div className="rw-container">
                            <div className="stage-header" id="extraccion-tambor-x">
                                <span class="stage-title">Extracción tambor x</span> - Nro de lote - Nro partida - fecha
                            </div>
                        ...
                        <div className="rw-container">
                            <div className="stage-header" id="extraccion-tambor-y">
                                <span class="stage-title">Extracción tambor y</span> - Nro de lote - Nro partida - fecha
                            </div>
                        ...
                        <div className="rw-container">  
                            <div className="stage-header" id="extraccion-tambor-z">
                                <span class="stage-title">Ingreso tambor z</span> - Nro de lote - Nro partida - fecha
                            </div>
